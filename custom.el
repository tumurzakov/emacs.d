(custom-set-variables
 ...
 '(ibuffer-saved-filter-groups (quote (("groups" ("nasa-filer" (filename . "/home/nathan/devel/nasa/filer/"))) ("default" ("dired" (mode . dired-mode)) ("haskell" (mode . haskell-mode)) ("python" (mode . python-mode)) ("notes" (or (name . "^\\*Calendar\\*$") (name . "^diary$") (mode . org-mode))) ("*buffer*" (name . "\\*.*\\*"))))))
 '(ibuffer-saved-filters (quote (("builtin-buffers" ((name . "^\\*.*\\*$"))) ("nasa-filer" ((filename . "/home/nathan/devel/nasa/filer/"))) ("gnus" ((or (mode . message-mode) (mode . mail-mode) (mode . gnus-group-mode) (mode . gnus-summary-mode) (mode . gnus-article-mode)))) ("programming" ((or (mode . emacs-lisp-mode) (mode . cperl-mode) (mode . c-mode) (mode . java-mode) (mode . idl-mode) (mode . lisp-mode)))))))
 '(ido-everywhere t)
 ...
 '(package-selected-packages (quote (ace-jump-buffer ag zenburn-theme windsize use-package smex smart-mode-line slime rainbow-mode rainbow-delimiters projectile powerline-evil neotree keychain-environment ido-vertical-mode ido-ubiquitous ibuffer-vc ggtags flx-ido exec-path-from-shell elisp-slime-nav company)))
